...
function getSnapshootOfFiberTree(fiberRoot, workInProgress, note = '') {
...
window.collectSnapshoot = function (fiberRoot, workInProgress, note) {
  const snapshoot = getSnapshootOfFiberTree(fiberRoot, workInProgress, note);
  snapshoots.push(snapshoot);
}

window.getSnapshoots = function () {
  console.log(JSON.stringify(snapshoots, null, 2));
}

window.clearSnapshoots = function () {
  snapshoots = []
}
